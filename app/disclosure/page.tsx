...
export const metadata: Metadata = {
  ...
  description:
    "StorePicks's affiliate disclosure policy. Learn how we may earn commissions through partner links on our site.",
};
  ...
  return (
    <div className="relative pt-32 pb-20 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-6 text-[#839BBE] leading-relaxed">
          <section>
          ...
          <section>
            ...
            <p>
              Some of the links on StorePicks are affiliate links. This means that
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F0F2FE] mb-3">No Impact on Rankings</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F0F2FE] mb-3">Partners</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F0F2FE] mb-3">Questions</h2>
            <p>
