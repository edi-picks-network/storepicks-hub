  ...
  return (
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6">
      <div className="max-w-[1200px] mx-auto flex flex-col items-center text-center">
        ...
        >
          <span className="w-2 h-2 rounded-full bg-[#A3E635] pulse-dot" />
          <span className="text-sm font-medium text-[#A3E635]">200+ Video Tools Reviewed</span>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              className="mr-2 px-6 py-2.5 bg-[#84CC16] hover:bg-[#65A30D] text-white text-sm font-medium rounded-full transition-colors flex-shrink-0"
            >
              Search
            </button>
          </div>
