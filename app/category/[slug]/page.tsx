      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-10">
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#84CC16] hover:bg-[#65A30D] text-white text-sm font-medium rounded-full transition-colors"
          >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#1E3A5F]">
                    ...
                    <span className="text-sm text-[#84CC16] font-semibold group-hover:text-[#A3E635] transition-colors flex items-center">
          ...
          <section className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {relatedPosts.map((post) => (
                ...
                >
                  <span className="inline-block text-[10px] font-semibold uppercase tracking-wider text-[#84CC16] bg-[#162540] px-2 py-0.5 rounded mb-3">
                    {post.category}
                  </span>
                  <h3 className="font-bold text-[#F0F2FE] group-hover:text-[#84CC16] transition-colors leading-snug line-clamp-2 mb-2">
                    {post.title}
                  </h3>
