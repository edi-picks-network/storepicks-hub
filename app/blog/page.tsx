            ...
            >
              <article className="bg-[#0F1F2D] border border-[#1E3A5F] rounded-xl p-6 card-hover h-full flex flex-col">
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-semibold uppercase tracking-wider text-[#84CC16] bg-[#162540] px-2.5 py-1 rounded-md">
                    {post.category}
                  </span>
                ...
                {/* Title */}
                <h2 className="text-lg font-bold text-[#F0F2FE] mb-3 group-hover:text-[#84CC16] transition-colors leading-snug">
                  {post.title}
                </h2>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#1E3A5F]">
                  ...
                  <ArrowRight className="w-4 h-4 text-[#84CC16] opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
              </article>
            </Link>
          ))}
